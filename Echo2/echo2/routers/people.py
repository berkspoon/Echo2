...
async def get_person(
    ...
    if act_ids:
        ...
        if lead_ids_set:
            ...
            leads_map = {str(l["id"]): {**l, "stage_label": stage_labels.get(l.get("rating"), (l.get("rating") or "").replace("_", " ").title())} for l in (leads_resp.data or [])}
        # Group lead links by activity_id
        act_lead_map = {}
