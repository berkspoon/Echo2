...
ORGANIZATION_FIELDS = [
    ...
    # Client Team Coverage (visible when org is a client, suggested to encourage filling in)
    {"field_name": "client_team_coverage_1", "display_name": "Client Team Coverage 1", "field_type": "lookup", "section_name": "Client Team", "display_order": 42, "storage_type": "eav", "is_system": False, "grid_default_visible": False, "visibility_rules": {"when": "relationship_type", "equals": "client"}, "suggestion_rules": {"when": "relationship_type", "equals": "client"}},
    {"field_name": "client_team_coverage_2", "display_name": "Client Team Coverage 2", "field_type": "lookup", "section_name": "Client Team", "display_order": 43, "storage_type": "eav", "is_system": False, "grid_default_visible": False, "visibility_rules": {"when": "relationship_type", "equals": "client"}, "suggestion_rules": {"when": "relationship_type", "equals": "client"}},
    {"field_name": "client_team_coverage_3", "display_name": "Client Team Coverage 3", "field_type": "lookup", "section_name": "Client Team", "display_order": 44, "storage_type": "eav", "is_system": False, "grid_default_visible": False, "visibility_rules": {"when": "relationship_type", "equals": "client"}, "suggestion_rules": {"when": "relationship_type", "equals": "client"}},
    {"field_name": "client_team_coverage_4", "display_name": "Client Team Coverage 4", "field_type": "lookup", "section_name": "Client Team", "display_order": 45, "storage_type": "eav", "is_system": False, "grid_default_visible": False, "visibility_rules": {"when": "relationship_type", "equals": "client"}, "suggestion_rules": {"when": "relationship_type", "equals": "client"}},
    {"field_name": "client_team_coverage_5", "display_name": "Client Team Coverage 5", "field_type": "lookup", "section_name": "Client Team", "display_order": 46, "storage_type": "eav", "is_system": False, "grid_default_visible": False, "visibility_rules": {"when": "relationship_type", "equals": "client"}, "suggestion_rules": {"when": "relationship_type", "equals": "client"}},
    # Legacy IDs
